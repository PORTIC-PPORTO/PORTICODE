Dentro desta pasta há um conjunto de projetos que oferecem formas diferentes de se preparar uma máquina virtual que funciona como nó IoT Edge local, ou seja, uma Gateway virtualizada. 
